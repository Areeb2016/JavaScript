...
router.post('/addcs', (req, res, next) => {
    ...
    member.save().then(result => {
        console.log(result);
        res.status(201).json({
            message: 'Handling POST requests to /ieeecs',
...
router.patch('/editcs/:memberID', (req, res, next) => {
    const id = req.params.memberID;
    const updateOps = {};
...
router.delete('/delcs/:memberID', (req, res, next) => {
    const id = req.params.memberID;
