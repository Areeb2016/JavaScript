...
router.post('/addras', (req, res, next) => {
    ...
    member.save().then(result => {
        console.log(result);
        res.status(201).json({
            message: 'Handling POST requests to /ieeeras',
...
router.patch('/editras/:memberID', (req, res, next) => {
    const id = req.params.memberID;
    const updateOps = {};
...
router.delete('/delras/:memberID', (req, res, next) => {
    const id = req.params.memberID;
